...
import ch.thomaswhittacre.easymouse.mouse.MouseInputs;
import ch.thomaswhittacre.easymouse.mouse.MovementHandler;
import ch.thomaswhittacre.easymouse.ui.mouse.MouseUsageDialog;
...
public class MouseFragment extends Fragment {
     ...
     */
    public MouseFragment(MouseInputs mouse, MovementHandler movement) {
    ...
    private void init() {
        ...
        root.post(() -> { // Wait for root view to get its size
    ...
    private boolean viewTouched(MotionEvent event) {
        ...
        if (this.middle != middle) {
            ...
            if (!middle && middleDecided && !middleScrolling)
                vibrate(buttonLength, buttonIntensity);
        }

        // Send Data
        if (this.middle != middle && !middle && middleDecided && !middleScrolling)
