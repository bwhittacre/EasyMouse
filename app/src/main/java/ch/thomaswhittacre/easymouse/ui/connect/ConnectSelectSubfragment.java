package ch.thomaswhittacre.easymouse.ui.connect;
...
import ch.thomaswhittacre.easymouse.transmission.BluetoothHandler;
import ch.thomaswhittacre.easymouse.transmission.HostDevice;
import ch.thomaswhittacre.easymouse.ui.connect.dialog.AddDialog;
import ch.thomaswhittacre.easymouse.ui.connect.dialog.InfoDialog;
...
public class ConnectSelectSubfragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView list = view.findViewById(R.id.connect_select_items);
        Button add = view.findViewById(R.id.connect_select_add);
    ...
    private static class ListAdapter extends RecyclerView.Adapter<ListAdapter.ViewHolder> {
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public ViewHolder(View view) {
                ...
                ImageView settings = view.findViewById(R.id.connect_select_list_item_settings);
